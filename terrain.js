class Terrain {
    ...
    draw(ctx) {
      ...
      ctx.drawImage(ASSET_MANAGER.getAsset("./assets/blocks/spritesheet.png"), 0, 0, 800, 800, this.x - this.game.camera.x, this.y-this.game.camera.y, 200*this.scale, 200*this.scale);
      ctx.strokeStyle = 'red';
