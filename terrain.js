class Terrain {
    ...
    draw(ctx) {
      ...
      ctx.drawImage(ASSET_MANAGER.getAsset("./assets/blocks/spritesheet.png"), this.choice, 0, 800, 800, this.x - this.game.camera.x, this.y-this.game.camera.y, 100*this.scale, 100*this.scale);
      ctx.strokeStyle = 'red';
