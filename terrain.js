class Terrain {
    ...
    draw(ctx) {
      ...
      ctx.drawImage(ASSET_MANAGER.getAsset("./assets/blocks/spritesheet_pastels.png"), this.choice, 0, 800, 800, this.x - this.game.camera.x, this.y-this.game.camera.y, params.blockSize, params.blockSize);
      ctx.strokeStyle = 'red';
