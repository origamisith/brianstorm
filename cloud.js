class Cloud {
  ...
  draw(ctx) {
    ...
    ctx.drawImage(ASSET_MANAGER.getAsset("./assets/environment/clouds/cloud.png"), 0, 0, 800, 800, this.x-this.game.camera.x/10, this.y - this.game.camera.y/10, 200, 200);
  }
}
